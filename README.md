...
## Current status — Milestone 4 (Recommendation)
...
| **M4 — Recommendation** | Asset scoring, recommendation engine, optimisation, backtesting | **In progress** |
...
[`PHASE-4-RECOMMENDATION.md`](Docs/PLAN/PHASE-4-RECOMMENDATION.md). Model cards are in
