...
| **M3 — ML** | Feature engineering, risk model, market prediction, model registry | **In progress** |
...
[`PHASE-3-ML.md`](Docs/PLAN/PHASE-3-ML.md). Model cards are in
...
being the expected, honest outcome for one-month return prediction.
...
backend/          FastAPI service
  ...
  app/api/v1/     Routes — auth, user, health, market, risk
  app/providers/  Data-provider abstraction (§7.3) — the only place a vendor SDK lives
  app/ml/         Features, risk and prediction models, registry, evaluation
